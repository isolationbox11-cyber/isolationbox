...
export function ProfessionalAlertsButton() {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <Badge 
            className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0 text-xs bg-gradient-to-br from-blue-500 to-blue-600 animate-pulse shadow-[0_0_8px_rgba(59,130,246,0.6)]"
          >
            3
          </Badge>
        </Button>
        ...
        <DropdownMenuItem className="focus:bg-blue-950/50 focus:text-blue-300">
          <div className="flex gap-3 w-full">
            ...
            <div className="flex flex-col space-y-1">
              ...
              <p className="text-xs text-blue-300/50 mt-1">Suspicious login attempt detected from unknown IP address</p>
            </div>
          </div>
        </DropdownMenuItem>
        <DropdownMenuItem className="focus:bg-blue-950/50 focus:text-blue-300">
          <div className="flex gap-3 w-full">
            ...
            <div className="flex flex-col space-y-1">
              ...
              <p className="text-xs text-blue-300/50 mt-1">Elevated traffic patterns detected on secure channels</p>
            </div>
          </div>
        </DropdownMenuItem>
        <DropdownMenuItem className="focus:bg-blue-950/50 focus:text-blue-300">
          <div className="flex gap-3 w-full">
            ...
            <div className="flex flex-col space-y-1">
              <p className="text-sm font-medium text-green-400">Info: Security Update Applied</p>
              <p className="text-xs text-blue-300/70">1 hour ago</p>
              <p className="text-xs text-blue-300/50 mt-1">System security patches successfully deployed</p>
            </div>
          </div>
        </DropdownMenuItem>
        <DropdownMenuSeparator className="bg-blue-800/50" />
