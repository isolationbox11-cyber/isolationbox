...
export function FloatingEyes() {
  ...
  return (
    <div className="fixed pointer-events-none z-50">
      ...
      >
        <div className="w-3 h-3 rounded-full bg-sky-500 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-lg shadow-sky-500/50"></div>
      </div>
      ...
      >
        <div className="w-2 h-2 rounded-full bg-blue-400 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-lg shadow-blue-400/50"></div>
      </div>
      ...
      {new Date().getMonth() === 9 && (
        ...
        >
          <div className="w-4 h-4 rounded-full bg-cyan-500 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-lg shadow-cyan-500/50"></div>
        </div>
      )}
    </div>
  )
