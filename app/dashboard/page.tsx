    ...
    <div className="flex-1 space-y-6 p-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-blue-500">🔐 Security Status: Active</span>
        </div>
      </div>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-bold text-blue-400 mb-2">Advanced Security Suite</h3>
              <p className="text-muted-foreground mb-4">
                Protect your digital infrastructure with our comprehensive security package. Enhanced threat detection and real-time monitoring.
              </p>
            </div>
            <div>
